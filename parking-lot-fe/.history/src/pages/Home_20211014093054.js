                            ...
                            <tr onClick={() => history.push(`/edit/${event.id}`)} class="text-gray-700 hover:bg-gray-100" key={event.id}>
                                <td class="px-4 py-3 border">
                                    <div class="flex items-center text-sm">
                                        <div>
                                            <p class="sm:text-xs font-semibold text-black">{event.title}</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-4 py-3 sm:text-xs font-semibold border">{event.date}</td>
                                <td class="px-4 py-3 sm:text-xs border">
                                    {(() => {
                                        if (event.status == 0) {
