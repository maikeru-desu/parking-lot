        ...
        <section class="container mx-auto p-6">
            <div class="grid grid-cols-7">
                <select
                    ...
                    className="mb-5 col-start-6 col-span-7 block appearance-none w-full border border-gray-200 text-gray-700 py-3 px-4 pr- rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
