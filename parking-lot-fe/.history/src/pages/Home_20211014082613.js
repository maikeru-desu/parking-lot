        ...
        <section class="container mx-auto p-6">
            <div class="grid grid-cols-7">
                <select
                    ...
                    className="mb-5 col-start-6 col-span- block appearance-none w-full border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
