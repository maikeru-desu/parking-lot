    ...
    return (
        <section class="container mx-auto p-6">
            <div class="grid grid-cols-4">
                <button onClick={() => history.push("/add")} className="mb-5 col-span-2 bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">
                    Add Event
                </button>
