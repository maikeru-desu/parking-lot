        ...
        <section class="container mx-auto p-6">
            <div class="grid grid-cols-7">
                <input
                    ...
                    className="mb-5 col-start-1 col-span-4 appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                />
